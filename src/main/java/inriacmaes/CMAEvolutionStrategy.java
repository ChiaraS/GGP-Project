...
is implemented in class <code>{@link inriacmaes.examples.CMAExample2}</code>.</P>
...
public class CMAEvolutionStrategy implements java.io.Serializable {
	...
	/**
	 * Turn off printing on standard output.
	 *
	 * @author C.Sironi
	 */
	public boolean turnOffPrinting = false;
