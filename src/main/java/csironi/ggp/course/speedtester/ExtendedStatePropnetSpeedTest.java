...
* internal check of the propnet building time and with extended machine state).
...
public class ExtendedStatePropnetSpeedTest {
	...
	public static void main(String[] args) {
		...
		String type = "ExtendedStatePropnet";
		if(withCache){
			type = "Cached" + type;
		}
      ...
      for(String gameKey : theRepository.getGameKeys()) {
          ...
          thePropnetMachine = new ExtendedStatePropnetStateMachine(new Random());
