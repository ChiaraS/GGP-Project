...
public class MyMinmaxGamer extends SampleGamer {
	 ...
	 *
	 */
	private double minscore(MachineState state, Role myRole, Move myMove, int myIndex, int opponentIndex)
			throws TransitionDefinitionException, MoveDefinitionException,
			GoalDefinitionException, StateMachineException{
		...
		for (Move move: moves){
			...
			double currentScore = maxscore(stateMachine.getNextState(state, jointMoves), myRole, myIndex, opponentIndex);
	 ...
	 *
	 */
	private double maxscore(MachineState state, Role myRole, int myIndex, int opponentIndex)
			throws TransitionDefinitionException, MoveDefinitionException,
			GoalDefinitionException, StateMachineException{
