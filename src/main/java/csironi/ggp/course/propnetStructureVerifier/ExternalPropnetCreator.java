 ...
 * interrupted if taking too long. This class is used only by the ExternalPropnetStructureChecker.
 *
 * @author C.Sironi
 *
 */
public class ExternalPropnetCreator extends Thread {
	 ...
	 */
	public ExternalPropnetCreator(List<Gdl> description) {
		this.propNet = null;
	...
	public void run(){
		try{
			...
			this.propNet = ExternalizedStatePropnetFactory.create(this.description);
