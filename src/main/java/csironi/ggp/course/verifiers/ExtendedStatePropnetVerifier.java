 ...
 * propnet building time and with extended machine state) wrt the prover state machine.
 *
 ...
 *
 */
public class ExtendedStatePropnetVerifier {
	...
	public static void main(String[] args) throws InterruptedException{
        ...
        ExtendedStatePropnetStateMachine theHiddenPropnetMachine;

        GamerLogger.setSpilloverLogfile("ExtendedStatePropnetVerifierTable.csv");
        GamerLogger.log(FORMAT.CSV_FORMAT, "ExtendedStatePropnetVerifierTable", "Game key;Initialization time (ms);Construction time (ms);Rounds;Completed rounds;Test duration (ms);Subject exception;Other exceptions;Pass;");
        ...
        for(String gameKey : theRepository.getGameKeys()) {
            ...
            GamerLogger.startFileLogging(fakeMatch, "ExtendedStatePropnetVerifier");
            ...
            theHiddenPropnetMachine = new ExtendedStatePropnetStateMachine(random);
            ...
            GamerLogger.log(FORMAT.CSV_FORMAT, "ExtendedStatePropnetVerifierTable", gameKey + ";" + initializationTime + ";" + theHiddenPropnetMachine.getPropnetConstructionTime() + ";" + rounds + ";" + completedRounds + ";" + testDuration + ";"  + exception + ";"  + otherExceptions + ";" + pass + ";");
        }
	}
}
