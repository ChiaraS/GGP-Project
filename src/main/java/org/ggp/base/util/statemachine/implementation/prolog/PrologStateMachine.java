...
public class PrologStateMachine extends StateMachine {
	 ...
	 */
	private MachineState currentPrologState;
	...
	private MachineState computeInitialState() throws StateMachineException
	{
		...
		this.currentPrologState = new MachineState(support.askToState((String[]) bindings[0]));
	...
	public List<Move> getLegalMoves(MachineState state, Role role)
		...
		List<Move> moves = support.askToMoves(prologMoves);
	 ...
	 */
	private void updatePrologState(MachineState state) throws StateMachineException{
