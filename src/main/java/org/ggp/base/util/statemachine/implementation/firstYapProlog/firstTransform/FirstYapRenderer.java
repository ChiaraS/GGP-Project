...
public class FirstYapRenderer {
	...
	{
		return FirstMappingYapFacilitator.scrambleConstant(constant.getValue());
	}
	...
	{
		return FirstMappingYapFacilitator.scrambleVariable(variable.getName());
	}
