...
public class YapEngineSupport {
	 ...
	 */
	public List<ExplicitRole> askToRoles(String[] response) throws SymbolFormatException
	{
	...
	private ExplicitRole mapRole(String fakeRole) throws SymbolFormatException
	{
