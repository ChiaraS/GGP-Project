...
public class L4J2SeparateInternalPropnetCreationManager extends Thread{
	...
	public L4J2SeparateInternalPropnetCreationManager(List<Gdl> description, long timeout) {
