 ...
 *
 */
public class OldUCTSelection implements SelectionStrategy {
	...
	public OldUCTSelection(int numRoles, InternalPropnetRole myRole, Random random, double uctOffset, double c) {
	...
	private MCTSJointMove ductSelect(PnDecoupledMCTSNode currentNode) {
	...
	private MCTSJointMove suctSelect(PnSequentialMCTSNode currentNode){
	...
	private MCTSJointMove ssuctSelect(PnSlowSeqentialMCTSNode currentNode){
