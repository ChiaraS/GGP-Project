...
import org.ggp.base.player.gamer.statemachine.MCTS.manager.propnet.strategies.backpropagation.TerminalTDBackpropagation;
...
import org.ggp.base.player.gamer.statemachine.MCTS.manager.propnet.strategies.playout.StandardPlayout;
...
public class TerminalTDDuctMctsGamer extends TDDuctMctsGamer {
	...
	public InternalPropnetMCTSManager createPropnetMCTSManager() {
		...
		TDBackpropagation backpropagation = new TerminalTDBackpropagation(this.thePropnetMachine, numRoles, this.qPlayout, this.lambda, this.gamma);
		...
		return new InternalPropnetMCTSManager(new UCTSelection(numRoles, myRole, r, this.valueOffset, new UCTEvaluator(this.c, this.unexploredMoveDefaultSelectionValue)),
	       		new NoExpansion(), new StandardPlayout(this.thePropnetMachine, new RandomJointMoveSelector(this.thePropnetMachine)),
