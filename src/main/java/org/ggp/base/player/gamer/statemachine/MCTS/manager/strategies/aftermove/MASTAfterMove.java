package org.ggp.base.player.gamer.statemachine.MCTS.manager.strategies.aftermove;
...
public class MASTAfterMove implements AfterMoveStrategy {
	...
	public MASTAfterMove(Map<InternalPropnetMove, MoveStats> mastStatistics, double decayFactor) {
