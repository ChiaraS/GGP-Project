...
//	private PlayoutStrategy playoutStrategy;
	...
	public Move stateMachineSelectMove(long timeout)
		...
		if(System.currentTimeMillis() < realTimeout){
			...
			LOGGER.info("[Gamer] Selecting move using MCS.");
			...
			try {
		    	...
		    	LOGGER.info("[Gamer] Returning MCS move " + theMove + ".");
			}catch(MCSException e){
				LOGGER.error("[Gamer] MCS failed to return a move.", e);
			...
			theMove = this.thePropnetMachine.getRandomMove(this.getCurrentState(), this.getRole());
			LOGGER.info("[Gamer] No time to select next move using MCS. Returning random move " + theMove + ".");
		}
