...
public abstract class ProverMctsGamer extends ProverGamer {
	 ...
	 */
	protected ProverMCTSManager mctsManager;

	public ProverMctsGamer() {
	...
	public ExplicitMove stateMachineSelectMove(long timeout)
		...
		if(System.currentTimeMillis() < realTimeout){
			...
			try {
				...
				theMove = theMachine.getRandomMove(this.getCurrentState(), this.getRole());
	...
	public abstract ProverMCTSManager createMCTSManager();
