...
public abstract class SearchManagerComponent {
	...
	public enum PLAYOUT_STAT_UPDATE_TYPE{
		SCORES, WINS, RESCALED_SCORES, RESCALED_WINS, SINGLE_WINNER,
		ALL_WINNERS, SINGLE_WINNER_AND_LOSERS, ALL_WINNERS_AND_LOSERS,
		PROPORTIONAL_SINGLE_WINNER, PROPORTIONAL_ALL_WINNERS,
		PROPORTIONAL_SINGLE_WINNER_AND_LOSERS, PROPORTIONAL_ALL_WINNERS_AND_LOSERS,
		LOSERS_WITH_SINGLE_WINNER, LOSERS_WITH_ALL_WINNERS
