...
public class PnSlowSeqentialMCTSNode extends MctsNode {
	 ...
	 */
	private PnSlowSequentialMCTSMoveStats[] movesStats;
	 ...
	 */
	private List<PnSlowSequentialMCTSMoveStats> unvisitedLeaves;
	...
	public PnSlowSequentialMCTSMoveStats[] getMovesStats(){
		return this.movesStats;
	}

	public List<PnSlowSequentialMCTSMoveStats> getUnvisitedLeaves(){
