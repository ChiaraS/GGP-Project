...
public class SlowAdaptivePlayoutAfterSimulation extends AfterSimulationStrategy {

	private List<Map<Move, Double>> weightsPerMove;

	public SlowAdaptivePlayoutAfterSimulation(GameDependentParameters gameDependentParameters, Random random,
