...
public class PnAllMemorizingStandardPlayout extends PnStandardPlayout {

	public PnAllMemorizingStandardPlayout(
	...
	public PnSimulationResult playout(CompactMachineState state, int maxDepth) {
        ...
        return new PnSimulationResult(nDepth, allJointMoves, allGoals);
