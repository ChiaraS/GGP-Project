...
public class ProverUCTEvaluator implements ProverMoveEvaluator {
	...
	public ProverUCTEvaluator(double c, double defaultValue) {
		this.c = c;
	...
	protected double computeExploitation(int allMoveVisits, ExplicitMove theMove,  MoveStats theMoveStats){
