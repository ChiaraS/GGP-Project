...
public class PnSUCTTreeNodeFactory implements TreeNodeFactory {
	...
	public PnSUCTTreeNodeFactory(InternalPropnetStateMachine theMachine, InternalPropnetRole myRole) {
