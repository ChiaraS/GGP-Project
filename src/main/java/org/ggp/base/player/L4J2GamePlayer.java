...
import org.ggp.base.player.request.factory.L4J2RequestFactory;
...
public final class L4J2GamePlayer extends Thread implements Subject
{
	/**
    ...
    public L4J2GamePlayer(int port, Gamer gamer) throws IOException
    {
		...
		while (listener != null) {
			...
			try {
				...
				*/
				...
				L4J2Request request = new L4J2RequestFactory().create(gamer, in);
	...
	/*public static void main(String[] args)
	{
		...
		try {
			L4J2GamePlayer player = new L4J2GamePlayer(Integer.valueOf(args[0]), new RandomGamer());
			player.run();
