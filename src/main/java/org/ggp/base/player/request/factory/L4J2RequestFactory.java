...
import org.ggp.base.player.request.grammar.L4J2AbortRequest;
import org.ggp.base.player.request.grammar.L4J2InfoRequest;
import org.ggp.base.player.request.grammar.L4J2PlayRequest;
import org.ggp.base.player.request.grammar.L4J2PreviewRequest;
import org.ggp.base.player.request.grammar.L4J2Request;
import org.ggp.base.player.request.grammar.L4J2StartRequest;
import org.ggp.base.player.request.grammar.L4J2StopRequest;
...
public final class L4J2RequestFactory
{
	public L4J2Request create(Gamer gamer, String source) throws RequestFormatException
	{
		try
		{
	...
	private L4J2PlayRequest createPlay(Gamer gamer, SymbolList list) throws GdlFormatException
	{
		if (list.size() != 3)
		{
		...
		return new L4J2PlayRequest(gamer, matchId, moves);
	}

	private L4J2StartRequest createStart(Gamer gamer, SymbolList list) throws GdlFormatException
	{
		if (list.size() < 6)
		{
		...
		return new L4J2StartRequest(gamer, matchId, roleName, theReceivedGame, startClock, playClock);
	}

	private L4J2StopRequest createStop(Gamer gamer, SymbolList list) throws GdlFormatException
	{
		if (list.size() != 3)
		{
			throw new IllegalArgumentException("Expected exactly 2 arguments!");
		...
		return new L4J2StopRequest(gamer, matchId, moves);
	}

    private L4J2AbortRequest createAbort(Gamer gamer, SymbolList list) throws GdlFormatException
    {
        if (list.size() != 2)
        {
        ...
        return new L4J2AbortRequest(gamer, matchId);
    }

    private L4J2InfoRequest createInfo(Gamer gamer, SymbolList list) throws GdlFormatException
    {
        if (list.size() != 1)
        {
        ...
        return new L4J2InfoRequest(gamer);
    }

    private L4J2PreviewRequest createPreview(Gamer gamer, SymbolList list) throws GdlFormatException
    {
		if (list.size() != 3)
		{
			throw new IllegalArgumentException("Expected exactly 2 arguments!");
		...
		Game theReceivedGame = Game.createEphemeralGame(theRulesheet);
		return new L4J2PreviewRequest(gamer, theReceivedGame, previewClock);
    }
