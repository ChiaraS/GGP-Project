...
public final class L4J2StartRequest extends L4J2Request
{
	...
	public L4J2StartRequest(Gamer gamer, String matchId, GdlConstant roleName, Game theGame, int startClock, int playClock)
	{
		this.gamer = gamer;
