...
public abstract class SubprocessEngine extends AbstractPrologEngine{
	...
	*/
	...
	/** XSB threads are not always present, AND they preclude reconsults one more than one thread is active
	so we'll resort to the old Unix signals; older versions will work on Windows, 
	but they require the InterProlog builtin*/
