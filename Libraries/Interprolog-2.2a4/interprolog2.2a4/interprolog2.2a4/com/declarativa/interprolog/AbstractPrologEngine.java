...
public abstract class AbstractPrologEngine implements PrologEngine{
    ...
    /** A (first) top goal is eternally active; so  deterministicGoal calls will be handled during the 
    execution of javaMessage. This strategy is followed oly in AbstractNativeEngines, so we don't lose the 
    experience (in Subprocessengines) of the original Prolog interactive ?- top level*/
	...
	*/
	...
	protected void loadInitialFile(){
    	...
    	String tempPath = unescapedFilePath(tempDirectory.getAbsolutePath());
	...
	*/	
	public Object[] deterministicGoal(String G, String OVar, Object[] objectsP, String RVars){
        ...
        try{
            ...
            progressMessage("dG - Got result for "+goalToDo);
    ...
    public ResultFromJava doCallback(Object x){
        ...
        try {
            ...
            // The result will be an invisible object, except if a String or a wrapper or a TermModel or an array...
            ...
            && !(result instanceof String) && !(result instanceof TermModel) && !(result.getClass().isArray())
