...
public class SWISubprocessEngineTest extends SubprocessEngineTest {
	...
	public void testAbortsAreDifferent(){ // this is not doable in XSB at the moment
		try{ 
			engine.deterministicGoal("abort");
			fail("should have thrown exception");
		} catch(IPException E){
			if (E instanceof IPInterruptedException) fail("should not have thrown IPInterruptedException");
		}
	}
}
